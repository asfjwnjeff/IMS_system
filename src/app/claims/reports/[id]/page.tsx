...
export default function ClaimDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const items: DescItem[] = [
    ...
    { label: '保单单号', value: claim.policyNumber },
    { label: '保险公司名称', value: claim.insuranceCompanyName },
    { label: '被保险人企业名称', value: claim.insuredCompanyName, span: 2 },
    { label: '保险公司理赔结果', value: claim.claimResult || '-' },
    { label: '保险公司理赔金额', value: d.claimAmount ? `¥${Number(d.claimAmount).toLocaleString()}` : '-' },
    { label: '业务参考号', value: v('jobidref') },
    ...
    { label: '中文商品名称', value: v('productNameCn') },
    { label: '货物数量', value: v('cargoQuantity') },
    { label: '包装种类', value: v('packageTypeDesc') },
